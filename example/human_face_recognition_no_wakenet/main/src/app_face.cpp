            ...
            if (self->switch_on)
            {
                ...
                if (self->state)
                {
                    if (detect_results.size() == 1)
                    {
                        ...
                        else if (self->state == FACE_RECOGNIZE)
                        {
                            ...
                            if (self->recognize_result.id > 0 && self->recognize_result.similarity > 0.97){
                ...
                if (self->frame_count)
                {
                    ...
                    if (self->frame_count <= 0) {
                        self->recognize_result.similarity = -1.0;
